...
import io.relution.jenkins.amazonsqs.i18n.sqstriggerqueue.Messages;
...
public class SQSTriggerQueue extends AbstractDescribableImpl<SQSTriggerQueue> implements io.relution.jenkins.amazonsqs.interfaces.SQSQueue {
    ...
    private transient io.relution.jenkins.amazonsqs.interfaces.SQSFactory factory;
    ...
    public SQSTriggerQueue(
        ...
        if ((credentialsId == null) || credentialsId.isEmpty()) {
            ...
            if (scresult == null) {
                this.accessKey = "";
                this.secretKey = null;
                io.relution.jenkins.amazonsqs.logging.Log.info("SQSTriggerQueue: No credentials found for id{%s}", credentialsId);
        ...
        io.relution.jenkins.amazonsqs.logging.Log.info("Create new SQSTriggerQueue(%s, %s, %s)", this.uuid, nameOrUrl, this.accessKey);
    }
    ...
    public SQSTriggerQueue(
        ...
        io.relution.jenkins.amazonsqs.logging.Log.info("Create new SQSTriggerQueue(%s, %s, %s)", this.uuid, nameOrUrl, accessKey);
    }
    ...
    @Inject
    public void setFactory(final io.relution.jenkins.amazonsqs.interfaces.SQSFactory factory) {
        this.factory = factory;
    }

    public io.relution.jenkins.amazonsqs.interfaces.SQSFactory getFactory() {
