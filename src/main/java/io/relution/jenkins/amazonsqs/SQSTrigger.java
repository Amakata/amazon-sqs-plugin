...
import io.relution.jenkins.amazonsqs.i18n.sqstrigger.Messages;
import io.relution.jenkins.amazonsqs.interfaces.SQSQueue;
import io.relution.jenkins.amazonsqs.interfaces.SQSQueueMonitorScheduler;
import io.relution.jenkins.amazonsqs.logging.Log;
import io.relution.jenkins.amazonsqs.model.events.ConfigurationChangedEvent;
import io.relution.jenkins.amazonsqs.model.events.EventBroker;
...
import static io.relution.jenkins.amazonsqs.util.JobInfoHelpers.asParameterizedJobMixIn;

public class SQSTrigger extends Trigger<Job<?, ?>> implements io.relution.jenkins.amazonsqs.interfaces.SQSQueueListener, Runnable {
...
//    private transient EventTriggerMatcher eventTriggerMatcher;
    ...
    public SQSQueueMonitorScheduler getScheduler() {
        if (this.scheduler == null) {
            io.relution.jenkins.amazonsqs.Context.injector().injectMembers(this);
        }
...
//        }
    ...
    private void startJob(Map<String, String> jobParameters) {
        ...
        if (descriptor instanceof DescriptorImpl) {
            ...
            List<io.relution.jenkins.amazonsqs.SQSTriggerQueue> queues = impl.getSqsQueues();
            if (!queues.isEmpty()) {
...
//    }
    ...
    public static final class DescriptorImpl extends TriggerDescriptor {
        ...
        private volatile List<io.relution.jenkins.amazonsqs.SQSTriggerQueue> sqsQueues;

        private volatile transient Map<String, io.relution.jenkins.amazonsqs.SQSTriggerQueue> sqsQueueMap;
        ...
        public ListBoxModel doFillQueueUuidItems() {
            final List<io.relution.jenkins.amazonsqs.SQSTriggerQueue> queues = this.getSqsQueues();
            final ListBoxModel items = new ListBoxModel();

            for (final io.relution.jenkins.amazonsqs.SQSTriggerQueue queue : queues) {
        ...
        public boolean configure(final StaplerRequest req, final JSONObject json) throws FormException {
            ...
            this.sqsQueues = req.bindJSONToList(io.relution.jenkins.amazonsqs.SQSTriggerQueue.class, sqsQueues);
            this.initQueueMap();
            this.save();
        ...
        public List<io.relution.jenkins.amazonsqs.SQSTriggerQueue> getSqsQueues() {
            if (!this.isLoaded) {
                this.load();
            }
        ...
        private void initQueueMap() {
            ...
            for (final io.relution.jenkins.amazonsqs.SQSTriggerQueue queue : this.sqsQueues) {
