...
import io.relution.jenkins.amazonsqs.model.constants.ErrorCode;
import io.relution.jenkins.amazonsqs.util.ErrorType;
...
public class SQSChannelImpl implements SQSChannel {
    ...
    public SQSChannelImpl(final AmazonSQS sqs, final SQSQueue queue, final io.relution.jenkins.amazonsqs.net.RequestFactory factory) {
