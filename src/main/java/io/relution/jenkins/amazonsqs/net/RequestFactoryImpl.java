...
public class RequestFactoryImpl implements RequestFactory {
    ...
    @Override
    public ReceiveMessageRequest createReceiveMessageRequest(final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue) {
    ...
    @Override
    public DeleteMessageBatchRequest createDeleteMessageBatchRequest(final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue, final List<Message> messages) {
