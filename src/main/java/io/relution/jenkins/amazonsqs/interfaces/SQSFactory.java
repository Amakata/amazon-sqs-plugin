...
package io.relution.jenkins.amazonsqs.interfaces;
 ...
 * {@link io.relution.jenkins.amazonsqs.interfaces.SQSQueue} by polling the queue for new messages.
 */
public interface SQSFactory {

    /**
     * Returns a new Amazon SQS instance that can be used to access the specified queue.
     * @param queue The {@link io.relution.jenkins.amazonsqs.interfaces.SQSQueue} for which to create a client.
     * @return A new instance of an {@link AmazonSQS} that is suitable for synchronous access to
     * the specified queue.
     */
    AmazonSQS createSQS(final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue);
     ...
     */
    AmazonSQSAsync createSQSAsync(final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue);

    /**
     * Returns a new channel instance that can be used to communicate with the specified queue.
     * @param queue The {@link io.relution.jenkins.amazonsqs.interfaces.SQSQueue} for which to create the channel.
     * @return A new {@link SQSChannel} for the specified queue.
     */
    SQSChannel createChannel(final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue);
     ...
     * @param queue The {@link io.relution.jenkins.amazonsqs.interfaces.SQSQueue} for which to create a monitor.
     * @return A new {@link SQSQueueMonitor} instance suitable for monitoring the specified queue.
     */
    SQSQueueMonitor createMonitor(final ExecutorService executor, final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue);
     ...
     */
    SQSQueueMonitor createMonitor(final SQSQueueMonitor monitor, final io.relution.jenkins.amazonsqs.interfaces.SQSQueue queue);
}
