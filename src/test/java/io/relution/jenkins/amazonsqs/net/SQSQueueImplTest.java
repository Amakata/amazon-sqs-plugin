...
public class SQSQueueImplTest {
    ...
    private io.relution.jenkins.amazonsqs.net.SQSChannel channel;
    ...
    public void init() {
        ...
        this.channel = new io.relution.jenkins.amazonsqs.net.SQSChannelImpl(this.sqs, this.queue, this.factory);
    }
